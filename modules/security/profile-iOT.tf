resource "fortisase_security_profile_group" "iOT" {
  primary_key = "iOT"
...
resource "fortisase_security_ssl_ssh_profile" "iOT" {
...
resource "fortisase_security_dlp_profile" "iOT" {
  primary_key = fortisase_security_profile_group.iOT.primary_key
  dlp_rules   = []
}

resource "fortisase_security_file_filter_profile" "iOT" {
  primary_key                    = fortisase_security_profile_group.iOT.primary_key
...
resource "fortisase_security_antivirus_profile" "iOT" {
  primary_key = fortisase_security_profile_group.iOT.primary_key
  http        = "enable"
  smtp        = "enable"
  pop3        = "enable"
...
resource "fortisase_security_dns_filter_profile" "iOT" {
  primary_key                        = fortisase_security_profile_group.iOT.primary_key
  use_fortiguard_filters             = "enable"
  fortiguard_filters                 = local.fgd_categories_all_monitor
  domain_filters                     = []
...
resource "fortisase_security_application_control_profile" "iOT" {
  primary_key                         = fortisase_security_profile_group.iOT.primary_key
...
resource "fortisase_security_ips_profile" "iOT" {
  primary_key               = fortisase_security_profile_group.iOT.primary_key
