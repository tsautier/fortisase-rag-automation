resource "fortisase_endpoint_policies" "sse_strict" {
...
resource "fortisase_endpoint_connection_profiles" "sse_strict" {
  primary_key = fortisase_endpoint_policies.sse_strict.primary_key
...
resource "fortisase_endpoint_protection_profiles" "sse_strict" {
  primary_key    = fortisase_endpoint_policies.sse_strict.primary_key
  antivirus      = "enable"
  ...
  depends_on = [ fortisase_endpoint_connection_profiles.sse_strict ]
}

# Sandbox

resource "fortisase_endpoint_sandbox_profiles" "sse_strict" {
  primary_key                      = fortisase_endpoint_policies.sse_strict.primary_key
...
resource "fortisase_endpoint_setting_profiles" "sse_strict" {
  primary_key             = fortisase_endpoint_policies.sse_strict.primary_key
